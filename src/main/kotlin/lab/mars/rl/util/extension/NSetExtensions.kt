 ...
 * @author wumo
 */
fun <T : Any> nsetOf(dimension: Any, element_maker: (IntSlice) -> Any): NSet<T> {
...
private fun <T : Any> make(rootDim: IntSlice, sub: Array<Dimension>, index: DefaultIntSlice,
                           element_maker: (IntSlice) -> Any): NSet<T> {
